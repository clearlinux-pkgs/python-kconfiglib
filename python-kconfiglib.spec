...
%prep
%setup -q -n Kconfiglib-13.3.2
cd %{_builddir}/Kconfiglib-13.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575281809
...
cp %{_builddir}/Kconfiglib-13.3.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/python-kconfiglib/864f15fbb4dcd073bbe20eb3c0b839a45b8902ab
