...
Version  : 8.0.0
Release  : 8
URL      : https://github.com/ulfalizer/Kconfiglib/archive/v8.0.0.tar.gz
Source0  : https://github.com/ulfalizer/Kconfiglib/archive/v8.0.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1531241172
