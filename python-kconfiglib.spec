...
Source0  : https://github.com/ulfalizer/Kconfiglib/archive/v13.6.0/Kconfiglib-13.6.0.tar.gz
...
%prep
%setup -q -n Kconfiglib-13.6.0
cd %{_builddir}/Kconfiglib-13.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576778560
...
cp %{_builddir}/Kconfiglib-13.6.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/python-kconfiglib/864f15fbb4dcd073bbe20eb3c0b839a45b8902ab
