...
Version  : 13.7.1
Release  : 107
URL      : https://github.com/ulfalizer/Kconfiglib/archive/v13.7.1/Kconfiglib-13.7.1.tar.gz
Source0  : https://github.com/ulfalizer/Kconfiglib/archive/v13.7.1/Kconfiglib-13.7.1.tar.gz
...
%prep
%setup -q -n Kconfiglib-13.7.1
cd %{_builddir}/Kconfiglib-13.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578944393
...
cp %{_builddir}/Kconfiglib-13.7.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/python-kconfiglib/864f15fbb4dcd073bbe20eb3c0b839a45b8902ab
