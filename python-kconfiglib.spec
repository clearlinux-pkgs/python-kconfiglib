...
Source0  : https://github.com/ulfalizer/Kconfiglib/archive/v13.3.0/Kconfiglib-13.3.0.tar.gz
...
%prep
%setup -q -n Kconfiglib-13.3.0
cd %{_builddir}/Kconfiglib-13.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574404134
...
cp %{_builddir}/Kconfiglib-13.3.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/python-kconfiglib/864f15fbb4dcd073bbe20eb3c0b839a45b8902ab
